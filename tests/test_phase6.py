...
def test_jwt_token_creation_and_decoding():
    payload = {"sub": "user@trainpilot.ai", "role": "ADMIN"}
    ...
    assert decoded["sub"] == "user@trainpilot.ai"
...
def test_system_health_and_prometheus_metrics():
    ...
    assert "trainpilot_uptime_seconds" in prom
    assert "trainpilot_cpu_utilization_pct" in prom
